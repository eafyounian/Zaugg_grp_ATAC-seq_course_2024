...
As noted above, the following part may seem a bit custom. 
...
We will first download the whole *HOCOMOCO* *PWM* database (which includes many files), and we then convert the downloaded *PWM* matrices to proper motif objects in R. *PWM* stands for *Position Weight
Matrix* and describes the probability to find the respective nucleotides
...
Depending on the number of cores, the following code will run 10-30
