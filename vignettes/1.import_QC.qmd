---
title: "Importing the data into R and Signac+Seurat, initial QC and clustering"
...
# Subset to a smaller object (5k peaks, 1k cells) for testing purposes
seu = seu[1:20000,1:1000]
...
outliers for the QC metrics that we defined above or that have been identified as doublets. Note that setting
...
# For testing purposes, we are here subsetting the seurat object to 20k peaks and 5k cells.

######################################################
# Do NOT execute this line when you run the vignette #
######################################################
seu.s = seu.s[1:20000, 1:5000]
...
below) can be used to visualize the data. Let's create a two-dimensional *embedding* of the data!
...
[scDblFinder R package for doublet detection](https://bioconductor.org/packages/release/bioc/vignettes/scDblFinder)
